...
import com.reinertisa.supapi.dtorequest.*;
import com.reinertisa.supapi.enumeration.TokenType;
import com.reinertisa.supapi.handler.ApiLogoutHandler;
...
import static com.reinertisa.supapi.constant.Constants.FILE_STORAGE;
...
public class UserResource {
    ...
    public UserResource(UserService userService, JwtService jwtService, ApiLogoutHandler logoutHandler) {
    ...
    public ResponseEntity<Response> toggleAccountExpired(@AuthenticationPrincipal User user,
        ...
        return ResponseEntity.ok().body(getResponse(request, emptyMap(),
                "Account updated successfully.", OK));
    }
    ...
    public ResponseEntity<Response> updatePassword(@AuthenticationPrincipal User user,
        ...
        userService.updatePassword(
                ...
                passwordRequest.getConfirmNewPassword());
        return ResponseEntity.ok().body(getResponse(request, emptyMap(),
    ...
    public ResponseEntity<Response> resetPassword(@RequestBody @Valid EmailRequest emailRequest,
        ...
        return ResponseEntity.ok().body(getResponse(request, emptyMap(),
                "We sent you an email to reset your password.", OK));
    }
    ...
    public ResponseEntity<Response> doResetPassword(@RequestBody @Valid ResetPasswordRequest resetPasswordRequest,
        ...
        return ResponseEntity.ok().body(getResponse(request, emptyMap(),
                "Password reset successfully", OK));
    }
    ...
    public ResponseEntity<Response> list(@AuthenticationPrincipal User user, HttpServletRequest request) {
        return ResponseEntity.ok().body(getResponse(request, Map.of("user", userService.getUsers()),
                "Users retrieved.", OK));
    }
    ...
    public ResponseEntity<Response> uploadPhoto(@AuthenticationPrincipal User user,
        ...
        return ResponseEntity.ok().body(getResponse(request, Map.of("imageUrl", imageUrl),
                "Photo update successfully.", OK));
    }
    ...
    public ResponseEntity<Response> logout(HttpServletRequest request, HttpServletResponse response,
        ...
        return ResponseEntity.ok().body(getResponse(request, emptyMap(),
                "You've logged out successfully.", OK));
    }
}
